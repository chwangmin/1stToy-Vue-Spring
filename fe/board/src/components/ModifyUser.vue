  ...
  >
    <b-form @submit.prevent="handleSubmit">
      <b-form-group label="아이디">
        <b-form-input v-model="form.memberId" readonly disabled></b-form-input>
      </b-form-group>
...
export default {
  ...
  computed: {
    ...
    phoneState() {
      ...
      return /^[0-9]{3}-[0-9]{4}-[0-9]{4}$/.test(this.form.phoneNumber);
    },
    phoneFeedback() {
  ...
  methods: {
    ...
    validatePhone() {
      // 숫자만 입력되도록 필터링
      let numbers = this.form.phoneNumber.replace(/[^0-9]/g, "");
    ...
    async handleSubmit() {
      ...
      try {
        ...
        const phoneWithoutHyphens = this.form.phoneNumber.replace(/-/g, "");
